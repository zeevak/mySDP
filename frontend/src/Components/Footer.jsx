      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div className="mt-8 pt-8 border-t border-green-200">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <img src="/images/certifications/organic.png" alt="USDA Organic" className="h-12" />
            <img src="/images/certifications/fsc.png" alt="FSC Certified" className="h-12" />
            <img src="/images/certifications/rainforest-alliance.png" alt="Rainforest Alliance" className="h-12" />
